...
export const surahsMetadata: SurahMetadata[] = [
  ...
  { number: 14, name: "إبراهيم", englishName: "Ibrahim", englishNameTranslation: "Abrahim", numberOfAyahs: 52, revelationType: "Meccan" },
  ...
  { number: 99, name: "الزلزلة", englishName: "Az-Zilzal", englishNameTranslation: "The Earthquake", numberOfAyahs: 8, revelationType: "Medinan" },
